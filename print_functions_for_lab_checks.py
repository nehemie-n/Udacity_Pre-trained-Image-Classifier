...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        pct_corr_dog = ( n_class_cdog / (n_pet_dog or 1) )*100 # Modified by nehemie054@gmail.com to avoid ZeroDivisionError
        pct_corr_notdog = ( n_class_cnotd / (n_pet_notd or 1) )*100 # Modified by nehemie054@gmail.com to avoid ZeroDivisionError
        pct_corr_breed = ( n_match_breed / (n_pet_dog or 1) )*100 # Modified by nehemie054@gmail.com to avoid ZeroDivisionError
