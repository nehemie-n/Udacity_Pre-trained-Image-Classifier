...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("{:20}: {:.1f}%".format('pct_match', results_stats_dic['pct_match']))
    print("{:20}: {:.1f}%".format('pct_correct_dogs', results_stats_dic['pct_correct_dogs']))
    print("{:20}: {:.1f}%".format('pct_correct_breed', results_stats_dic['pct_correct_breed']))
    print("{:20}: {:.1f}%".format('pct_correct_notdogs', results_stats_dic['pct_correct_notdogs']))
